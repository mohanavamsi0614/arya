...
function UserDash() {
  ...
  useEffect(()=>{
    ...
    console.log(userId)
    axios.get(`https://arya-server.onrender.com/api/orders/${userId}`)
    .then((response) => {
        ...
        <div className="orders-section">
          ...
          <div className="past-orders">
            ...
            <div className="past-order-list">
              {order.filter(o => o.status === "Completed" || o.status === "rejected").length === 0 ? (
                    ...
                    <div className="past-order-items">
                      ...
                      >
                        <img
                          src="down.png"
                          alt="Chevron"
                          className={expandedOrderId === (o._id || idx) ? "expanded" : ""}
                        />
                      </div>
                    </div>
