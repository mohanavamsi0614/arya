            ...
            <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                  ...
                  <form onSubmit={(e) => { e.preventDefault(); handleSave(); }}>
                    ...
                    <div className="form-group">
                      ...
                      >
                        ...
                        {categories.map(cat => (
                          <option key={cat} value={cat}>{formatSectionName(cat)}</option>
                        ))}
                      </select>
              ...
              <div className="modal-footer">
                ...
                {modalType === 'delete' ? (
                  ...
                  >
                    {deletingItem && <span className="loading-spinner-small"></span>}
                  ...
                  <>
                    ...
                    >
                      {savingItem && <span className="loading-spinner-small"></span>}
